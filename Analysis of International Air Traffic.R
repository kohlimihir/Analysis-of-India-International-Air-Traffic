data <- read.csv("C:/Users/mihir/Downloads/Proj/International Air Traffic/Airlinewise Monthly International Air Traffic To And From The Indian Territory.csv")
library(tidyverse)
library(dplyr)
library(ggplot2)
...
data%>%map(~sum(is.na(.)))
#1value in passenger to india is NA
...
##Analysis on Passanger to India
